# `DDSCAT_jll.jl` (v7.3.3+0)

[![deps](https://juliahub.com/docs/DDSCAT_jll/deps.svg)](https://juliahub.com/ui/Packages/DDSCAT_jll/1uixH?page=2)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/45c5ab6377a0269b08c1eeba9680482241891a4c/D/DDSCAT/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `DDSCAT_jll.jl` have been built from these sources:

* compressed archive: http://ddscat.wikidot.com/local--files/downloads/ddscat7.3.3_220120.tgz (SHA256 checksum: `06f2673a45fcff20b8ed9f37d5bedeb84604d7a9fb10f627096833163769d1e7`)

## Platforms

`DDSCAT_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `DDSCAT_jll.jl`:
